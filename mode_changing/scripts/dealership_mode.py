## This is a Python Selenium Script that will put the unit into dealership mode. 
## Manual Selection of "Dealership Mode" is required, everything else is automated. 

from selenium.webdriver.common.by import By
from selenium.webdriver.common.keys import Keys
import time

def run_dealership_mode(driver):
    print("Running Dealership Mode...")
    ...
    try:
        for i in range(1, 11):  
            ...
            time.sleep(0.5)  # 0.5-second delay between Tab presses
    ...
    print("Manually select 'Dealership Mode' in the dropdown.")
    input("Press Enter here after selecting Dealership Mode to continue...")
